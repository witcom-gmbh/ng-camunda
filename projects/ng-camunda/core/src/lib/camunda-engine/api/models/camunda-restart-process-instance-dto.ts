...
import { CamundaRestartProcessInstanceModificationInstructionDto } from './camunda-restart-process-instance-modification-instruction-dto';
export interface CamundaRestartProcessInstanceDto {
   ...
   */
  instructions?: Array<CamundaRestartProcessInstanceModificationInstructionDto>;

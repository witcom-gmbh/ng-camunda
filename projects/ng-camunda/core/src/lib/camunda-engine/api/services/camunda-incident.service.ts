...
import { CamundaIncidentDto } from '../models/camunda-incident-dto';

@Injectable({
  providedIn: 'root',
})
export class CamundaIncidentService extends BaseService {
  constructor(
  ...
  getIncidents$Response(params?: {
     ...
     */
    sortOrder?: 'asc' | 'desc';
  }): Observable<StrictHttpResponse<Array<CamundaIncidentDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaIncidentService.GetIncidentsPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<CamundaIncidentDto>>;
      })
    );
  }
  ...
  getIncidents(params?: {
     ...
     */
    sortOrder?: 'asc' | 'desc';
  }): Observable<Array<CamundaIncidentDto>> {

    return this.getIncidents$Response(params).pipe(
      map((r: StrictHttpResponse<Array<CamundaIncidentDto>>) => r.body as Array<CamundaIncidentDto>)
    );
  }
  ...
  getIncidentsCount$Response(params?: {
     ...
     */
    jobDefinitionIdIn?: string;
  }): Observable<StrictHttpResponse<Array<CamundaCountResultDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaIncidentService.GetIncidentsCountPath, 'get');
    if (params) {
      rb.query('incidentId', params.incidentId, {});
      rb.query('incidentType', params.incidentType, {});
      rb.query('incidentMessage', params.incidentMessage, {});
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<CamundaCountResultDto>>;
      })
    );
  }
  ...
  getIncidentsCount(params?: {
     ...
     */
    jobDefinitionIdIn?: string;
  }): Observable<Array<CamundaCountResultDto>> {

    return this.getIncidentsCount$Response(params).pipe(
      map((r: StrictHttpResponse<Array<CamundaCountResultDto>>) => r.body as Array<CamundaCountResultDto>)
    );
  }
  ...
  getIncident$Response(params: {
     ...
     */
    id: string;
  }): Observable<StrictHttpResponse<CamundaIncidentDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaIncidentService.GetIncidentPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<CamundaIncidentDto>;
      })
    );
  }
  ...
  getIncident(params: {
     ...
     */
    id: string;
  }): Observable<CamundaIncidentDto> {

    return this.getIncident$Response(params).pipe(
      map((r: StrictHttpResponse<CamundaIncidentDto>) => r.body as CamundaIncidentDto)
    );
  }
  ...
  resolveIncident$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaIncidentService.ResolveIncidentPath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }

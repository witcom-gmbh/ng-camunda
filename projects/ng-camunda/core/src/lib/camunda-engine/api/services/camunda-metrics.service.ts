...
import { CamundaMetricsIntervalResultDto } from '../models/camunda-metrics-interval-result-dto';
import { CamundaMetricsResultDto } from '../models/camunda-metrics-result-dto';

@Injectable({
  providedIn: 'root',
})
export class CamundaMetricsService extends BaseService {
  constructor(
  ...
  interval$Response(params?: {
  ...
  }): Observable<StrictHttpResponse<Array<CamundaMetricsIntervalResultDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaMetricsService.IntervalPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<CamundaMetricsIntervalResultDto>>;
      })
    );
  }
  ...
  interval(params?: {
     ...
     */
    aggregateByReporter?: string;
  }): Observable<Array<CamundaMetricsIntervalResultDto>> {

    return this.interval$Response(params).pipe(
      map((r: StrictHttpResponse<Array<CamundaMetricsIntervalResultDto>>) => r.body as Array<CamundaMetricsIntervalResultDto>)
    );
  }
  ...
  getMetrics$Response(params: {
     ...
     */
    endDate?: string;
  }): Observable<StrictHttpResponse<CamundaMetricsResultDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaMetricsService.GetMetricsPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<CamundaMetricsResultDto>;
      })
    );
  }
  ...
  getMetrics(params: {
     ...
     */
    endDate?: string;
  }): Observable<CamundaMetricsResultDto> {

    return this.getMetrics$Response(params).pipe(
      map((r: StrictHttpResponse<CamundaMetricsResultDto>) => r.body as CamundaMetricsResultDto)
    );
  }

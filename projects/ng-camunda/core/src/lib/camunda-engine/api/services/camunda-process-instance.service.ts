...
import { CamundaActivityInstanceDto } from '../models/camunda-activity-instance-dto';
import { CamundaBatchDto } from '../models/camunda-batch-dto';
import { CamundaCountResultDto } from '../models/camunda-count-result-dto';
import { CamundaDeleteProcessInstancesDto } from '../models/camunda-delete-process-instances-dto';
...
import { CamundaProcessInstanceModificationDto } from '../models/camunda-process-instance-modification-dto';
import { CamundaProcessInstanceQueryDto } from '../models/camunda-process-instance-query-dto';
import { CamundaProcessInstanceSuspensionStateAsyncDto } from '../models/camunda-process-instance-suspension-state-async-dto';
import { CamundaProcessInstanceSuspensionStateDto } from '../models/camunda-process-instance-suspension-state-dto';
import { CamundaSetJobRetriesByProcessDto } from '../models/camunda-set-job-retries-by-process-dto';
import { CamundaSetVariablesAsyncDto } from '../models/camunda-set-variables-async-dto';
import { CamundaSuspensionStateDto } from '../models/camunda-suspension-state-dto';
import { CamundaVariableValueDto } from '../models/camunda-variable-value-dto';

@Injectable({
  providedIn: 'root',
})
export class CamundaProcessInstanceService extends BaseService {
  constructor(
  ...
  getProcessInstances$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.GetProcessInstancesPath, 'get');
    if (params) {
  ...
  queryProcessInstances$Response(params?: {
     ...
     */
    maxResults?: number;
    body?: CamundaProcessInstanceQueryDto
  }): Observable<StrictHttpResponse<Array<CamundaProcessInstanceDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.QueryProcessInstancesPath, 'post');
    if (params) {
      rb.query('firstResult', params.firstResult, {});
      rb.query('maxResults', params.maxResults, {});
  ...
  getProcessInstancesCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.GetProcessInstancesCountPath, 'get');
    if (params) {
      rb.query('processInstanceIds', params.processInstanceIds, {});
      rb.query('businessKey', params.businessKey, {});
      rb.query('businessKeyLike', params.businessKeyLike, {});
  ...
  queryProcessInstancesCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.QueryProcessInstancesCountPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  deleteProcessInstancesAsyncOperation$Response(params?: {
     ...
     */
    body?: CamundaDeleteProcessInstancesDto
  }): Observable<StrictHttpResponse<CamundaBatchDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.DeleteProcessInstancesAsyncOperationPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  deleteAsyncHistoricQueryBased$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.DeleteAsyncHistoricQueryBasedPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  setRetriesByProcess$Response(params?: {
     ...
     * **Unallowed property**: `historicProcessInstanceQuery`
     */
    body?: CamundaSetJobRetriesByProcessDto
  }): Observable<StrictHttpResponse<CamundaBatchDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.SetRetriesByProcessPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  setRetriesByProcessHistoricQueryBased$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.SetRetriesByProcessHistoricQueryBasedPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  updateSuspensionState$Response(params?: {
    body?: CamundaProcessInstanceSuspensionStateDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.UpdateSuspensionStatePath, 'put');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  updateSuspensionStateAsyncOperation$Response(params?: {
    body?: CamundaProcessInstanceSuspensionStateAsyncDto
  }): Observable<StrictHttpResponse<CamundaBatchDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.UpdateSuspensionStateAsyncOperationPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  setVariablesAsyncOperation$Response(params?: {
    body?: CamundaSetVariablesAsyncDto
  }): Observable<StrictHttpResponse<CamundaBatchDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.SetVariablesAsyncOperationPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  getProcessInstance$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.GetProcessInstancePath, 'get');
    if (params) {
  ...
  deleteProcessInstance$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.DeleteProcessInstancePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
  ...
  getActivityInstanceTree$Response(params: {
     ...
     */
    id: string;
  }): Observable<StrictHttpResponse<CamundaActivityInstanceDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.GetActivityInstanceTreePath, 'get');
    if (params) {
      rb.path('id', params.id, {});
    }
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<CamundaActivityInstanceDto>;
      })
    );
  }
  ...
  getActivityInstanceTree(params: {
    ...
    return this.getActivityInstanceTree$Response(params).pipe(
      map((r: StrictHttpResponse<CamundaActivityInstanceDto>) => r.body as CamundaActivityInstanceDto)
    );
  }
  ...
  modifyProcessInstance$Response(params: {
     ...
     */
    id: string;
    body?: CamundaProcessInstanceModificationDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.ModifyProcessInstancePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  modifyProcessInstanceAsyncOperation$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.ModifyProcessInstanceAsyncOperationPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  updateSuspensionStateById$Response(params: {
     ...
     */
    id: string;
    body?: CamundaSuspensionStateDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.UpdateSuspensionStateByIdPath, 'put');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  getProcessInstanceVariables$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.GetProcessInstanceVariablesPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
  ...
  modifyProcessInstanceVariables$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.ModifyProcessInstanceVariablesPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  getProcessInstanceVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.GetProcessInstanceVariablePath, 'get');
    if (params) {
      rb.path('id', params.id, {});
  ...
  setProcessInstanceVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.SetProcessInstanceVariablePath, 'put');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
      rb.body(params.body, 'application/json');
  ...
  deleteProcessInstanceVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.DeleteProcessInstanceVariablePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
    }
  ...
  getProcessInstanceVariableBinary$Any$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.GetProcessInstanceVariableBinaryPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
    }
  ...
  setProcessInstanceVariableBinary$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaProcessInstanceService.SetProcessInstanceVariableBinaryPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});

...
export interface CamundaCorrelationMessageDto {
   ...
   */
  correlationKeys?: { [key: string]: CamundaVariableValueDto };
   ...
   */
  localCorrelationKeys?: { [key: string]: CamundaVariableValueDto };
   ...
   */
  processVariables?: { [key: string]: CamundaVariableValueDto };
   ...
   */
  processVariablesLocal?: { [key: string]: CamundaVariableValueDto };

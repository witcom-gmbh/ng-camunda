/* tslint:disable */
/* eslint-disable */
import { CamundaActivityInstanceIncidentDto } from './camunda-activity-instance-incident-dto';
import { CamundaTransitionInstanceDto } from './camunda-transition-instance-dto';

/**
 * A JSON object corresponding to the Activity Instance tree of the given process instance.
 */
export interface CamundaActivityInstanceDto {
   ...
   */
  childActivityInstances?: Array<CamundaActivityInstanceDto>;
   ...
   */
  childTransitionInstances?: Array<CamundaTransitionInstanceDto>;
   ...
   */
  incidents?: Array<CamundaActivityInstanceIncidentDto>;

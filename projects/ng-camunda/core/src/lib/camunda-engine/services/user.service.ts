...
import { ResourceOptionsDto } from '../models/resource-options-dto';
...
export class UserService extends BaseService {
  ...
  getUsers(params?: {
    ...
    return this.getUsers$Response(params).pipe(
      map((r: StrictHttpResponse<Array<UserProfileDto>>) => r.body as Array<UserProfileDto>)
    );
  }
  ...
  availableOperations$Response(params?: {
  }): Observable<StrictHttpResponse<ResourceOptionsDto>> {

    const rb = new RequestBuilder(this.rootUrl, UserService.AvailableOperationsPath, 'options');
    if (params) {
    }
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<ResourceOptionsDto>;
      })
    );
  }
  ...
  availableOperations(params?: {
    ...
    return this.availableOperations$Response(params).pipe(
      map((r: StrictHttpResponse<ResourceOptionsDto>) => r.body as ResourceOptionsDto)
    );
  }
  ...
  getUserCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, UserService.GetUserCountPath, 'get');
    if (params) {
      rb.query('id', params.id, {});
      rb.query('idIn', params.idIn, {});
      rb.query('firstName', params.firstName, {});
  ...
  availableUserOperations$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, UserService.AvailableUserOperationsPath, 'options');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  updateCredentials$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, UserService.UpdateCredentialsPath, 'put');
    if (params) {
      rb.path('id', params.id, {});

...
import { CamundaCompleteExternalTaskDto } from '../models/camunda-complete-external-task-dto';
import { CamundaCountResultDto } from '../models/camunda-count-result-dto';
import { CamundaExtendLockOnExternalTaskDto } from '../models/camunda-extend-lock-on-external-task-dto';
import { CamundaExternalTaskBpmnError } from '../models/camunda-external-task-bpmn-error';
import { CamundaExternalTaskDto } from '../models/camunda-external-task-dto';
import { CamundaExternalTaskFailureDto } from '../models/camunda-external-task-failure-dto';
import { CamundaExternalTaskQueryDto } from '../models/camunda-external-task-query-dto';
import { CamundaFetchExternalTasksDto } from '../models/camunda-fetch-external-tasks-dto';
import { CamundaLockedExternalTaskDto } from '../models/camunda-locked-external-task-dto';
import { CamundaPriorityDto } from '../models/camunda-priority-dto';
import { CamundaRetriesDto } from '../models/camunda-retries-dto';
import { CamundaSetRetriesForExternalTasksDto } from '../models/camunda-set-retries-for-external-tasks-dto';

@Injectable({
  providedIn: 'root',
})
export class CamundaExternalTaskService extends BaseService {
  constructor(
  ...
  getExternalTasks$Response(params?: {
     ...
     */
    maxResults?: number;
  }): Observable<StrictHttpResponse<Array<CamundaExternalTaskDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.GetExternalTasksPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<CamundaExternalTaskDto>>;
      })
    );
  }
  ...
  getExternalTasks(params?: {
     ...
     */
    maxResults?: number;
  }): Observable<Array<CamundaExternalTaskDto>> {

    return this.getExternalTasks$Response(params).pipe(
      map((r: StrictHttpResponse<Array<CamundaExternalTaskDto>>) => r.body as Array<CamundaExternalTaskDto>)
    );
  }
  ...
  queryExternalTasks$Response(params?: {
     ...
     */
    maxResults?: number;
    body?: CamundaExternalTaskQueryDto
  }): Observable<StrictHttpResponse<Array<CamundaExternalTaskDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.QueryExternalTasksPath, 'post');
    if (params) {
      rb.query('firstResult', params.firstResult, {});
      rb.query('maxResults', params.maxResults, {});
  ...
  getExternalTasksCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.GetExternalTasksCountPath, 'get');
    if (params) {
      rb.query('externalTaskId', params.externalTaskId, {});
      rb.query('externalTaskIdIn', params.externalTaskIdIn, {});
      rb.query('topicName', params.topicName, {});
  ...
  queryExternalTasksCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.QueryExternalTasksCountPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  fetchAndLock$Response(params?: {
    body?: CamundaFetchExternalTasksDto
  }): Observable<StrictHttpResponse<Array<CamundaLockedExternalTaskDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.FetchAndLockPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<CamundaLockedExternalTaskDto>>;
      })
    );
  }
  ...
  fetchAndLock(params?: {
    body?: CamundaFetchExternalTasksDto
  }): Observable<Array<CamundaLockedExternalTaskDto>> {

    return this.fetchAndLock$Response(params).pipe(
      map((r: StrictHttpResponse<Array<CamundaLockedExternalTaskDto>>) => r.body as Array<CamundaLockedExternalTaskDto>)
    );
  }
  ...
  setExternalTaskRetries$Response(params?: {
    body?: CamundaSetRetriesForExternalTasksDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.SetExternalTaskRetriesPath, 'put');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  setExternalTaskRetriesAsyncOperation$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.SetExternalTaskRetriesAsyncOperationPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  getTopicNames$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.GetTopicNamesPath, 'get');
    if (params) {
  ...
  getExternalTask$Response(params: {
     ...
     */
    id: string;
  }): Observable<StrictHttpResponse<CamundaExternalTaskDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.GetExternalTaskPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<CamundaExternalTaskDto>;
      })
    );
  }
  ...
  getExternalTask(params: {
     ...
     */
    id: string;
  }): Observable<CamundaExternalTaskDto> {

    return this.getExternalTask$Response(params).pipe(
      map((r: StrictHttpResponse<CamundaExternalTaskDto>) => r.body as CamundaExternalTaskDto)
    );
  }
  ...
  handleExternalTaskBpmnError$Response(params: {
     ...
     */
    id: string;
    body?: CamundaExternalTaskBpmnError
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.HandleExternalTaskBpmnErrorPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  completeExternalTaskResource$Response(params: {
     ...
     */
    id: string;
    body?: CamundaCompleteExternalTaskDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.CompleteExternalTaskResourcePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  getExternalTaskErrorDetails$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.GetExternalTaskErrorDetailsPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  extendLock$Response(params: {
     ...
     */
    id: string;
    body?: CamundaExtendLockOnExternalTaskDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.ExtendLockPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  handleFailure$Response(params: {
     ...
     */
    id: string;
    body?: CamundaExternalTaskFailureDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.HandleFailurePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  setExternalTaskResourcePriority$Response(params: {
     ...
     */
    id: string;
    body?: CamundaPriorityDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.SetExternalTaskResourcePriorityPath, 'put');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  setExternalTaskResourceRetries$Response(params: {
     ...
     */
    id: string;
    body?: CamundaRetriesDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.SetExternalTaskResourceRetriesPath, 'put');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  unlock$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaExternalTaskService.UnlockPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
    }

...
import { CamundaDeleteHistoricProcessInstancesDto } from '../models/camunda-delete-historic-process-instances-dto';
import { CamundaHistoricProcessInstanceDto } from '../models/camunda-historic-process-instance-dto';
import { CamundaHistoricProcessInstanceQueryDto } from '../models/camunda-historic-process-instance-query-dto';
import { CamundaSetRemovalTimeToHistoricProcessInstancesDto } from '../models/camunda-set-removal-time-to-historic-process-instances-dto';

@Injectable({
  providedIn: 'root',
})
export class CamundaHistoricProcessInstanceService extends BaseService {
  constructor(
  ...
  getHistoricProcessInstances$Response(params?: {
  ...
  }): Observable<StrictHttpResponse<Array<CamundaHistoricProcessInstanceDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.GetHistoricProcessInstancesPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<CamundaHistoricProcessInstanceDto>>;
      })
    );
  }
  ...
  getHistoricProcessInstances(params?: {
     ...
     */
    variableValuesIgnoreCase?: boolean;
  }): Observable<Array<CamundaHistoricProcessInstanceDto>> {

    return this.getHistoricProcessInstances$Response(params).pipe(
      map((r: StrictHttpResponse<Array<CamundaHistoricProcessInstanceDto>>) => r.body as Array<CamundaHistoricProcessInstanceDto>)
    );
  }
  ...
  queryHistoricProcessInstances$Response(params?: {
     ...
     */
    maxResults?: number;
    body?: CamundaHistoricProcessInstanceQueryDto
  }): Observable<StrictHttpResponse<Array<CamundaHistoricProcessInstanceDto>>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.QueryHistoricProcessInstancesPath, 'post');
    if (params) {
      rb.query('firstResult', params.firstResult, {});
      rb.query('maxResults', params.maxResults, {});
  ...
  getHistoricProcessInstancesCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.GetHistoricProcessInstancesCountPath, 'get');
    if (params) {
      rb.query('processInstanceId', params.processInstanceId, {});
      rb.query('processInstanceIds', params.processInstanceIds, {});
      rb.query('processDefinitionId', params.processDefinitionId, {});
  ...
  queryHistoricProcessInstancesCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.QueryHistoricProcessInstancesCountPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  deleteHistoricProcessInstancesAsync$Response(params?: {
    body?: CamundaDeleteHistoricProcessInstancesDto
  }): Observable<StrictHttpResponse<CamundaBatchDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.DeleteHistoricProcessInstancesAsyncPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  getHistoricProcessInstanceDurationReport$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.GetHistoricProcessInstanceDurationReportPath, 'get');
    if (params) {
  ...
  setRemovalTimeAsync$Response(params?: {
    body?: CamundaSetRemovalTimeToHistoricProcessInstancesDto
  }): Observable<StrictHttpResponse<CamundaBatchDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.SetRemovalTimeAsyncPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  getHistoricProcessInstance$Response(params: {
     ...
     */
    id: string;
  }): Observable<StrictHttpResponse<CamundaHistoricProcessInstanceDto>> {

    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.GetHistoricProcessInstancePath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<CamundaHistoricProcessInstanceDto>;
      })
    );
  }
  ...
  getHistoricProcessInstance(params: {
     ...
     */
    id: string;
  }): Observable<CamundaHistoricProcessInstanceDto> {

    return this.getHistoricProcessInstance$Response(params).pipe(
      map((r: StrictHttpResponse<CamundaHistoricProcessInstanceDto>) => r.body as CamundaHistoricProcessInstanceDto)
    );
  }
  ...
  deleteHistoricProcessInstance$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.DeleteHistoricProcessInstancePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
  ...
  deleteHistoricVariableInstancesOfHistoricProcessInstance$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CamundaHistoricProcessInstanceService.DeleteHistoricVariableInstancesOfHistoricProcessInstancePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }

...
import { HistoricActivityInstanceDto } from '../models/historic-activity-instance-dto';
import { HistoricActivityInstanceQueryDto } from '../models/historic-activity-instance-query-dto';

@Injectable({
  providedIn: 'root',
})
export class HistoricActivityInstanceService extends BaseService {
  constructor(
  ...
  getHistoricActivityInstances$Response(params?: {
  ...
  }): Observable<StrictHttpResponse<Array<HistoricActivityInstanceDto>>> {

    const rb = new RequestBuilder(this.rootUrl, HistoricActivityInstanceService.GetHistoricActivityInstancesPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<HistoricActivityInstanceDto>>;
      })
    );
  }
  ...
  getHistoricActivityInstances(params?: {
    ...
    return this.getHistoricActivityInstances$Response(params).pipe(
      map((r: StrictHttpResponse<Array<HistoricActivityInstanceDto>>) => r.body as Array<HistoricActivityInstanceDto>)
    );
  }
  ...
  queryHistoricActivityInstances$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, HistoricActivityInstanceService.QueryHistoricActivityInstancesPath, 'post');
    if (params) {
      rb.query('firstResult', params.firstResult, {});
      rb.query('maxResults', params.maxResults, {});
  ...
  getHistoricActivityInstancesCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, HistoricActivityInstanceService.GetHistoricActivityInstancesCountPath, 'get');
    if (params) {
      rb.query('activityInstanceId', params.activityInstanceId, {});
      rb.query('processInstanceId', params.processInstanceId, {});
      rb.query('processDefinitionId', params.processDefinitionId, {});
  ...
  queryHistoricActivityInstancesCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, HistoricActivityInstanceService.QueryHistoricActivityInstancesCountPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  getHistoricActivityInstance$Response(params: {
     ...
     */
    id: string;
  }): Observable<StrictHttpResponse<HistoricActivityInstanceDto>> {

    const rb = new RequestBuilder(this.rootUrl, HistoricActivityInstanceService.GetHistoricActivityInstancePath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<HistoricActivityInstanceDto>;
      })
    );
  }
  ...
  getHistoricActivityInstance(params: {
    ...
    return this.getHistoricActivityInstance$Response(params).pipe(
      map((r: StrictHttpResponse<HistoricActivityInstanceDto>) => r.body as HistoricActivityInstanceDto)
    );
  }
